...
struct HomeView:View{
    ...
    let actionMovie: [Movie]=[
        Movie(title: "Gravida", author: "Chris Evans", description: "Sci-fi about time travel.", image: "download"),
        Movie(title: "Darkness", author: "Emma Watson", description: "Horror film full of suspense.", image: "download"),
        Movie(title: "Luctus", author: "Robert Brown", description: "Historical war drama.", image: "download")
    ]
    
    let hororMovie: [Movie]=[
        Movie(title: "The Naked Gun (2025)", author: "Chris Evans", description: "Sci-fi about time travel.", image: "jumbo"),
        Movie(title: "The Bad Guys 2", author: "Emma Watson", description: "Horror film full of suspense.", image: ""),
